...
public class EnhanceOperatorEvaluate extends OperatorBase {

    public EnhanceOperatorEvaluate(String name) {
        this.name = name;
    }

    public EnhanceOperatorEvaluate(String aliasName, String name, String errorInfo) {
        this.name = name;
